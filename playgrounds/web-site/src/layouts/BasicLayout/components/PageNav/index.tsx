...
const Navigation = (props, context) => {
  ...
  useEffect(() => {
    const curSubNav = getAsideMenuConfig().find((menuConfig: any) => {
    ...
    if (curSubNav && curSubNav.name && !openKeys.includes(curSubNav.name)) {
  ...
  return (
    ...
    >
      {getNavMenuItems(getAsideMenuConfig(), 0, AUTH_CONFIG)}
    </Nav>
  )
}
